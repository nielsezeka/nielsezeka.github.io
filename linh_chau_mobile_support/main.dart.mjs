...
_1664: (o, t) => typeof o === t,
_1665: (o, c) => o instanceof c,
...
_1763: (a, b) => a == b ? 0 : (a > b ? 1 : -1),
_1764: a => a.length,
_1766: (a, i) => a[i],
_1767: (a, i, v) => a[i] = v,
_1768: (a, t) => a.concat(t),
...
_1810: (x0,x1) => x0.getRandomValues(x1),
_1811: x0 => new Uint8Array(x0),
...
_1848: (x0,x1) => x0.getAllKeys(x1),
_1849: (x0,x1) => x0.getAll(x1),
_1851: (x0,x1) => x0.delete(x1),
_1852: (x0,x1,x2) => x0.put(x1,x2),
_1853: x0 => x0.clear(),
_1854: x0 => x0.close(),
_1856: (x0,x1,x2) => x0.open(x1,x2),
_1861: (x0,x1) => x0.contains(x1),
_1862: (x0,x1) => x0.createObjectStore(x1),
_1863: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1863(f,arguments.length,x0) }),
_1864: (x0,x1) => x0.contains(x1),
_1865: (x0,x1) => x0.contains(x1),
_1866: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1866(f,arguments.length,x0) }),
_1897: () => new XMLHttpRequest(),
_1898: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
_1899: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
_1900: x0 => x0.abort(),
_1901: x0 => x0.getAllResponseHeaders(),
...
_1910: () => new XMLHttpRequest(),
_1912: () => new FileReader(),
_1913: (x0,x1) => x0.readAsArrayBuffer(x1),
...
_1923: (x0,x1,x2,x3) => x0.addEventListener(x1,x2,x3),
_1924: (x0,x1,x2,x3) => x0.removeEventListener(x1,x2,x3),
...
_1971: (x0,x1) => x0.test(x1),
_1972: (x0,x1) => x0.exec(x1),
_1973: (x0,x1) => x0.exec(x1),
_1974: x0 => x0.pop(),
_1978: (x0,x1,x2) => x0[x1] = x2,
_1980: o => o === undefined,
_1981: o => typeof o === 'boolean',
_1982: o => typeof o === 'number',
_1984: o => typeof o === 'string',
_1987: o => o instanceof Int8Array,
_1988: o => o instanceof Uint8Array,
_1989: o => o instanceof Uint8ClampedArray,
_1990: o => o instanceof Int16Array,
_1991: o => o instanceof Uint16Array,
_1992: o => o instanceof Int32Array,
_1993: o => o instanceof Uint32Array,
_1994: o => o instanceof Float32Array,
_1995: o => o instanceof Float64Array,
_1996: o => o instanceof ArrayBuffer,
_1997: o => o instanceof DataView,
_1998: o => o instanceof Array,
_1999: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
_2001: o => {
            const proto = Object.getPrototypeOf(o);
            return proto === Object.prototype || proto === null;
          },
_2002: o => o instanceof RegExp,
_2003: (l, r) => l === r,
_2004: o => o,
_2005: o => o,
_2006: o => o,
...
_2008: o => o.length,
_2011: (o, i) => o[i],
_2012: f => f.dartFunction,
_2013: l => arrayFromDartList(Int8Array, l),
_2014: (data, length) => {
...
_2015: l => arrayFromDartList(Uint8ClampedArray, l),
_2016: l => arrayFromDartList(Int16Array, l),
_2017: l => arrayFromDartList(Uint16Array, l),
_2018: l => arrayFromDartList(Int32Array, l),
_2019: l => arrayFromDartList(Uint32Array, l),
_2020: l => arrayFromDartList(Float32Array, l),
_2021: l => arrayFromDartList(Float64Array, l),
_2022: (data, length) => {
...
_2023: l => arrayFromDartList(Array, l),
_2024:       (s, length) => {
        if (length == 0) return '';
...
_2046: (x0,x1) => x0[x1],
_2049: x0 => x0.flags,
_2050: x0 => x0.multiline,
_2051: x0 => x0.ignoreCase,
_2052: x0 => x0.unicode,
_2053: x0 => x0.dotAll,
_2054: (x0,x1) => x0.lastIndex = x1,
_2055: (o, p) => p in o,
_2056: (o, p) => o[p],
...
_2239: x0 => x0.style,
_2252: (x0,x1) => x0.oncancel = x1,
_2258: (x0,x1) => x0.onchange = x1,
_2298: (x0,x1) => x0.onerror = x1,
_2596: (x0,x1) => x0.target = x1,
_2598: (x0,x1) => x0.download = x1,
_2623: (x0,x1) => x0.href = x1,
...
_7221: (x0,x1) => x0.innerHTML = x1,
_8766: x0 => x0.size,
_8767: x0 => x0.type,
_8774: x0 => x0.name,
_8775: x0 => x0.lastModified,
_8781: x0 => x0.length,
_8792: x0 => x0.result,
_10780: x0 => x0.result,
_10781: x0 => x0.error,
_10786: (x0,x1) => x0.onsuccess = x1,
_10788: (x0,x1) => x0.onerror = x1,
_10792: (x0,x1) => x0.onupgradeneeded = x1,
_10813: x0 => x0.version,
_10814: x0 => x0.objectStoreNames,
_10886: x0 => x0.key,
_10889: x0 => x0.value,
_11738: (x0,x1) => x0.display = x1
    };
