...
_1612: (x0,x1,x2) => x0.addEventListener(x1,x2),
_1619: (x0,x1,x2) => x0.removeEventListener(x1,x2),
...
_1643: x0 => x0.click(),
_1644: x0 => x0.remove(),
_1659: x0 => globalThis.URL.createObjectURL(x0),
_1660: x0 => x0.click(),
_1661: x0 => x0.remove(),
_1673: x0 => new Array(x0),
_1675: (o, t) => typeof o === t,
_1676: (o, c) => o instanceof c,
...
_1821: (x0,x1) => x0.getRandomValues(x1),
_1822: x0 => new Uint8Array(x0),
_1823: () => globalThis.crypto,
...
_1856: () => Date.now(),
_1857: (x0,x1,x2) => x0.transaction(x1,x2),
_1858: (x0,x1) => x0.objectStore(x1),
_1859: (x0,x1) => x0.getAllKeys(x1),
_1860: (x0,x1) => x0.getAll(x1),
_1862: (x0,x1) => x0.delete(x1),
...
_1875: (x0,x1) => x0.contains(x1),
_1876: (x0,x1) => x0.contains(x1),
_1877: f => finalizeWrapper(f, function(x0) { return dartInstance.exports._1877(f,arguments.length,x0) }),
_1908: () => new XMLHttpRequest(),
_1909: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
_1910: (x0,x1,x2) => x0.setRequestHeader(x1,x2),
_1911: x0 => x0.abort(),
_1912: x0 => x0.getAllResponseHeaders(),
...
_1982: (x0,x1) => x0.exec(x1),
_1983: x0 => x0.pop(),
_1987: (x0,x1,x2) => x0[x1] = x2,
_1989: o => o === undefined,
_1990: o => typeof o === 'boolean',
_1991: o => typeof o === 'number',
_1993: o => typeof o === 'string',
_1996: o => o instanceof Int8Array,
_1997: o => o instanceof Uint8Array,
_1998: o => o instanceof Uint8ClampedArray,
_1999: o => o instanceof Int16Array,
_2000: o => o instanceof Uint16Array,
_2001: o => o instanceof Int32Array,
_2002: o => o instanceof Uint32Array,
_2003: o => o instanceof Float32Array,
_2004: o => o instanceof Float64Array,
_2005: o => o instanceof ArrayBuffer,
_2006: o => o instanceof DataView,
_2007: o => o instanceof Array,
_2008: o => typeof o === 'function' && o[jsWrappedDartFunctionSymbol] === true,
_2010: o => {
            const proto = Object.getPrototypeOf(o);
            return proto === Object.prototype || proto === null;
          },
_2011: o => o instanceof RegExp,
_2012: (l, r) => l === r,
_2013: o => o,
_2014: o => o,
_2015: o => o,
...
_2017: o => o.length,
_2020: (o, i) => o[i],
_2021: f => f.dartFunction,
_2022: l => arrayFromDartList(Int8Array, l),
_2023: (data, length) => {
...
_2024: l => arrayFromDartList(Uint8ClampedArray, l),
_2025: l => arrayFromDartList(Int16Array, l),
_2026: l => arrayFromDartList(Uint16Array, l),
_2027: l => arrayFromDartList(Int32Array, l),
_2028: l => arrayFromDartList(Uint32Array, l),
_2029: l => arrayFromDartList(Float32Array, l),
_2030: l => arrayFromDartList(Float64Array, l),
_2031: (data, length) => {
...
_2032: l => arrayFromDartList(Array, l),
_2033:       (s, length) => {
        if (length == 0) return '';
...
_2064: (o, p) => p in o,
_2065: (o, p) => o[p],
_2161: (x0,x1) => x0.withCredentials = x1,
_2163: x0 => x0.responseURL,
_2164: x0 => x0.status,
_2165: x0 => x0.statusText,
_2167: (x0,x1) => x0.responseType = x1,
_2168: x0 => x0.response,
_2248: x0 => x0.style,
_2261: (x0,x1) => x0.oncancel = x1,
_2267: (x0,x1) => x0.onchange = x1,
_2307: (x0,x1) => x0.onerror = x1,
_2605: (x0,x1) => x0.target = x1,
_2607: (x0,x1) => x0.download = x1,
_2632: (x0,x1) => x0.href = x1,
_3180: (x0,x1) => x0.accept = x1,
_3194: x0 => x0.files,
_3220: (x0,x1) => x0.multiple = x1,
_3238: (x0,x1) => x0.type = x1,
_3979: () => globalThis.window,
_4021: x0 => x0.self,
_4022: x0 => x0.document,
_4044: x0 => x0.navigator,
_4301: x0 => x0.indexedDB,
_4435: x0 => x0.userAgent,
_4436: x0 => x0.vendor,
_6639: x0 => x0.type,
_6640: x0 => x0.target,
_6761: () => globalThis.document,
_6854: x0 => x0.body,
_7205: (x0,x1) => x0.id = x1,
_7229: (x0,x1) => x0.innerHTML = x1,
_8774: x0 => x0.size,
_8775: x0 => x0.type,
_8782: x0 => x0.name,
...
_10788: x0 => x0.result,
_10789: x0 => x0.error,
_10794: (x0,x1) => x0.onsuccess = x1,
_10796: (x0,x1) => x0.onerror = x1,
_10800: (x0,x1) => x0.onupgradeneeded = x1,
_10821: x0 => x0.version,
_10822: x0 => x0.objectStoreNames,
_10894: x0 => x0.key,
_10897: x0 => x0.value,
_11746: (x0,x1) => x0.display = x1
    };
